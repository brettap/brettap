...
for li in pagination_elements:
    page_number_li = li.find_element(by=By.TAG_NAME, value='button').text
...
# excel output file
output_file_name = "partners_workbookv_7.xlsx"
...
try:
    ...
    while page_number <= total_pages:
        ...
        for index in range(number_of_links):
            aws_partner_page = driver.find_element(by=By.CLASS_NAME, value='partner-link').get_attribute('href')
            links[index].click()
